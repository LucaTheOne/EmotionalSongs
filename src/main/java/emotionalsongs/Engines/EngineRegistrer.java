...
public class EngineRegistrer {
    ...
    public boolean validCF;
    public boolean cfNotSigned;
    public boolean validNome;
    public boolean validCognome;
    public boolean validDataNascita;
    public boolean validIndirizzo;
    public boolean validUserId;
    public boolean idNotTaken;
    public boolean validEmail;
    public boolean validPassword;
    public boolean passwordMatches;
    
    public boolean allRight = false;

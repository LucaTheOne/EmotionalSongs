 ...
 * @author big
 */
public class GUIBranoViewVotePanel extends javax.swing.JPanel {
     ...
     */
    public GUIBranoViewVotePanel(Song brano) {
        this.brano = brano;
        EngineChecker checker = new EngineChecker();
        votedYet = checker.checkIfVoted(EMOTIONALSONGS.loggedUser.getUserId(),brano,EMOTIONALSONGS.dataSetEmozioni);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        voteButton.setEnabled(!votedYet);
